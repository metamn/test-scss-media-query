...
Forget SASS. [Too many problems](https://github.com/metamn/test-scss-imports). Really. It's React time. Where all these problems are solved automatically, inside the box.

SASS and BEM were good mates enduring a good couple of years (5+ in my case) which in tech terms is an age.
